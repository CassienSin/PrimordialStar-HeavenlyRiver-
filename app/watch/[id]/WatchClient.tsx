  ...
  return (
    <>
      <style>{`
        ...
        .delete-btn { position: absolute; top: 12px; right: 12px; z-index: 10; background: rgba(192,57,43,0.85); color: white; border: none; border-radius: 4px; padding: 8px 16px; font-size: 13px; font-weight: 700; cursor: pointer; font-family: 'Nunito', sans-serif; backdrop-filter: blur(4px); transition: background 0.2s; display: flex; align-items: center; gap: 6px; }
